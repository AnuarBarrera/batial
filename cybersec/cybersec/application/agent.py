...
_OUTPUT_FORMAT_INSTRUCTIONS = _SEVERITY_CRITERIA + "\n\nTu respuesta final debe incluir, en este orden:\n" + (
    ...
    '(string). Si el hallazgo corresponde a un archivo de código concreto dentro del '
    'directorio analizado, agrega también "file_path" (string) con su ruta tal como '
    'aparece en list_code_files o read_code_snippet — solo para hallazgos de código, '
    'omite este campo (o déjalo vacío) para hallazgos de red, logs o sin archivo '
    'concreto asociado. '
    'Si el hallazgo coincide con uno de los HALLAZGOS ACEPTADOS FORMALMENTE, '
